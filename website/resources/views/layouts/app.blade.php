                            ...
                            <div class="flex items-center gap-4" x-data="{ open: false, intelOpen: false }" @click.away="open = false; intelOpen = false">
                                ...
                                <div class="relative" x-data="{ updatesOpen: false }" @click.away="updatesOpen = false">
                                    ...
                                    <div x-show="updatesOpen" 
                                         ...
                                         class="absolute right-0 mt-3 w-72 origin-top-right rounded-[2rem] bg-white dark:bg-slate-800 shadow-2xl border border-slate-100 dark:border-slate-700 p-6 z-50" 
                                         style="display: none;">
                                        
                                        <div class="flex items-center justify-between mb-6">
                                            <h4 class="text-[10px] font-black text-slate-900 dark:text-slate-100 uppercase tracking-[0.2em]">System Updates</h4>
                                            <span class="px-2 py-0.5 rounded-md bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-[7px] font-black uppercase tracking-widest">New</span>
                                        </div>

                                        <div class="space-y-4">
                                            <div class="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-50 dark:border-slate-700/50">
                                                <div class="flex items-center gap-2 mb-2">
                                                    <div class="h-1.5 w-1.5 rounded-full bg-emerald-500"></div>
                                                    <span class="text-[8px] font-black text-slate-400 uppercase tracking-widest">Security Update</span>
                                                </div>
                                                <p class="text-[11px] font-bold text-slate-700 dark:text-slate-200 leading-relaxed">
                                                    We have enhanced the encryption protocols on all login portals to ensure maximum data protection for Build v1.0.4.
                                                </p>
                                                <p class="text-[8px] font-medium text-slate-400 mt-2">Just now • Version 1.0.4</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
