...
<div class="form-group {{ $attributes->get('class') }}">
    <label for="{{ $name }}" class="block text-[11px] font-black text-slate-600 dark:text-slate-400 uppercase tracking-widest mb-2">{{ $label }} @if($required)<span class="text-rose-500">*</span>@endif</label>
