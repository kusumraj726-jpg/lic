<aside class="glass-sidebar shadow-xl">
    <div class="sidebar-header">
        <a href="{{ route('dashboard') }}" class="sidebar-logo flex items-center gap-3">
            <img src="{{ asset('images/logo.png') }}" alt="ERP Logo" class="h-9 w-9 object-contain rounded-xl shadow-md border border-slate-100">
            <span class="tracking-tight text-xs lg:text-sm font-black uppercase text-indigo-600">{{ auth()->user()->context()->company_name ?? 'Velora ERP' }}</span>
        </a>
    </div>
