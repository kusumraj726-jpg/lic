                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="form-group">
                            ...
                            <div x-show="availablePolicies.length > 0">
                                <select name="policy_number_select" x-model="policyNumberInput" @change="syncPolicyDetails()" class="form-control dark:bg-slate-800 dark:border-slate-700 dark:text-slate-100">
                            ...
                            <div x-show="availablePolicies.length === 0">
                                <input type="text" name="policy_number_manual" x-model="policyNumberInput" class="form-control dark:bg-slate-800 dark:border-slate-700 dark:text-slate-100" placeholder="Type Policy Number" required>
                            </div>
