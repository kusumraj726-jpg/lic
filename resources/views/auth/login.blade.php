            ...
            <div class="relative z-10 w-full h-full p-10 flex flex-col justify-between">
                <div>
                    <div class="flex items-center gap-3">
                        <div class="h-8 w-8 rounded-lg bg-white/20 backdrop-blur-md flex items-center justify-center border border-white/30">
                            <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                            </svg>
                        </div>
                        <span class="text-xl font-black text-white tracking-widest uppercase">NexoraByte</span>
                    </div>
                </div>

                <div class="space-y-4 max-w-sm">
                    <div class="space-y-2">
                        <h2 class="text-3xl lg:text-4xl font-black text-white leading-tight" x-text="role === 'Admin' ? 'Nexus Command Control' : 'Advisor Workspace'"></h2>
                        <p class="text-sm lg:text-base text-white/70 font-medium" x-text="role === 'Admin' ? 'The ultimate dashboard for managing your business ecosystem.' : 'Access your personalized workspace and daily operations.'"></p>
                    </div>
                        ...
                        <div class="space-y-1.5" x-data="{ show: false }">
                            <div class="flex justify-between items-center ml-1">
                                ...
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="text-[9px] font-black text-slate-300 hover:text-indigo-600 uppercase tracking-widest transition-colors">Recovery?</a>
                                @endif
                            </div>
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
