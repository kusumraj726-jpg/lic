                    ...
                    <div class="grid grid-cols-1 gap-3">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="company_name" :value="old('company_name')" required autofocus
                                class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border-none rounded-xl text-slate-900 dark:text-white text-sm font-bold placeholder-slate-300 focus:ring-2 focus:ring-indigo-500 transition-all shadow-sm"
