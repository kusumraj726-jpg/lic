<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-6">
            ...
            <div>
                <h2 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Add Staff Member</h2>
                            ...
                            <div class="relative group">
                                <div class="h-32 w-32 rounded-[2rem] bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 p-1 shadow-2xl overflow-hidden">
                                    <div class="h-full w-full rounded-[1.85rem] bg-white dark:bg-slate-900 flex items-center justify-center overflow-hidden border-4 border-white dark:border-slate-900">
                                        <div id="avatar-preview" class="h-full w-full flex items-center justify-center bg-slate-50 dark:bg-slate-800 text-slate-400 dark:text-slate-500">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <label class="flex items-center justify-between p-6 bg-white dark:bg-slate-800/30 border border-slate-100 dark:border-slate-800 rounded-2xl cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all group shadow-sm dark:shadow-none">
                                    ...
                                    <div class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="{{ $p['key'] }}" value="1" class="sr-only peer" checked>
