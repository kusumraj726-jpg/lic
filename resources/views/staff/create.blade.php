    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white">New Staff Member</h2>
                    <p class="text-gray-500 dark:text-slate-400">Onboard a new member to your agency team.</p>
                </div>
            </div>
                    ...
                    <div class="p-8 space-y-10">
                        ...
                        <div
                            ...
                            <div class="relative group">
                                <div
                                    ...
                                    <div
                                        class="h-full w-full rounded-[1.75rem] bg-white flex items-center justify-center overflow-hidden border-4 border-white">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <x-form-input label="Email Address" name="staff_member_email_sec" type="email"
                                    placeholder="official@agency.com" autocomplete="off" required />
                                <x-form-input label="Phone Number" name="staff_member_phone_sec"
                                    placeholder="9876543210" minlength="10" maxlength="10" pattern="[0-9]{10}"
                                    title="10-digit Phone Number" autocomplete="off" />
                                <x-form-input label="Designation" name="staff_member_designation_sec"
                                    placeholder="e.g. Senior Advisor" autocomplete="off" />
                            </div>
                        </div>
                        ...
                        <div class="pt-8 border-t border-slate-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <x-form-input label="Create Password" name="password" type="password"
                                    placeholder="••••••••" minlength="8" autocomplete="new-password" readonly
                            ...
                            <div class="pt-8 border-t border-slate-100">
                                ...
                                <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-6 ml-1">Select
                                    the modules this staff member can access:</p>
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-4">
                                        <label class="flex-1 cursor-pointer group">
                                            <input type="radio" name="status" value="active" class="peer hidden dark:bg-slate-800 dark:border-slate-700 dark:text-slate-100 dark:placeholder-slate-500"
                                                checked>
                                            <div
                                        ...
                                        <label class="flex-1 cursor-pointer group">
                                            <input type="radio" name="status" value="inactive" class="peer hidden dark:bg-slate-800 dark:border-slate-700 dark:text-slate-100 dark:placeholder-slate-500">
                                            <div
