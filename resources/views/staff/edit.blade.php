        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-gray-500">Modify information for {{ $staff->name }}.</p>
                </div>
            </div>
                    ...
                    <div class="p-8 space-y-10">
                        ...
                        <div class="flex flex-col md:flex-row items-center gap-8 bg-slate-50/50 p-6 rounded-[2rem] border border-slate-100">
                            ...
                            <div class="flex-1 text-center md:text-left">
                                <h3 class="text-lg font-black text-slate-900 uppercase tracking-tight">Update Photo</h3>
                                <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest mt-1 mb-4">Change the team member's avatar</p>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <x-form-input label="Full Name" name="staff_member_name_sec" :value="old('staff_member_name_sec', $staff->name)" autocomplete="off" required />
                                <x-form-input label="Email Address" name="staff_member_email_sec" type="email" :value="old('staff_member_email_sec', $staff->email)" autocomplete="off" required />
                                <x-form-input label="Phone Number" name="staff_member_phone_sec" :value="old('staff_member_phone_sec', $staff->phone)" minlength="10" maxlength="10" pattern="[0-9]{10}" title="10-digit Phone Number" autocomplete="off" />
                                <x-form-input label="Designation" name="staff_member_designation_sec" :value="old('staff_member_designation_sec', $staff->designation)" autocomplete="off" />
                            </div>
                        </div>
                        ...
                        <div class="pt-8 border-t border-slate-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <x-form-input label="New Password (Optional)" name="password" type="password" placeholder="••••••••" minlength="8" autocomplete="new-password" />
                                <x-form-input label="Confirm New Password" name="password_confirmation" type="password" placeholder="••••••••" minlength="8" autocomplete="new-password" />
                            </div>
                        ...
                        <div class="pt-8 border-t border-slate-100">
                            ...
                            <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-6 ml-1">Update module permissions for this staff member:</p>
                            ...
                            <div class="gap-4 grid grid-cols-1 md:grid-cols-2 mb-8">
                                ...
                                <label class="flex items-center justify-between p-4 bg-white border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition-colors shadow-sm">
                                    ...
                                    <div class="relative flex items-center">
                                        <input type="checkbox" name="access_clients" value="1" class="peer sr-only" {{ $staff->access_clients ? 'checked' : '' }}>
                                ...
                                <label class="flex items-center justify-between p-4 bg-white border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition-colors shadow-sm">
                                    ...
                                    <div class="relative flex items-center">
                                        <input type="checkbox" name="access_queries" value="1" class="peer sr-only" {{ $staff->access_queries ? 'checked' : '' }}>
                                        <div class="w-14 h-7 bg-red-500 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-blue-600 shadow-inner"></div>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center justify-between p-4 bg-white border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition-colors shadow-sm">
                                    ...
                                    <div class="relative flex items-center">
                                        <input type="checkbox" name="access_claims" value="1" class="peer sr-only" {{ $staff->access_claims ? 'checked' : '' }}>
                                        <div class="w-14 h-7 bg-red-500 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-blue-600 shadow-inner"></div>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center justify-between p-4 bg-white border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition-colors shadow-sm">
                                    ...
                                    <div class="relative flex items-center">
                                        <input type="checkbox" name="access_renewals" value="1" class="peer sr-only" {{ $staff->access_renewals ? 'checked' : '' }}>
                                        <div class="w-14 h-7 bg-red-500 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-blue-600 shadow-inner"></div>
                                    </div>
                                </label>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    <label class="flex-1 cursor-pointer group">
                                        <input type="radio" name="status" value="active" class="peer hidden" {{ $staff->status == 'active' ? 'checked' : '' }}>
                                    ...
                                    <label class="flex-1 cursor-pointer group">
                                        <input type="radio" name="status" value="inactive" class="peer hidden" {{ $staff->status == 'inactive' ? 'checked' : '' }}>
