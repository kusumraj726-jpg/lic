                            ...
                            <div class="flex items-center justify-between mb-12">
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 mt-2">
                                        ...
                                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Team &amp; Client Celebrations</p>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-4">
                                <template x-if="dailyEvents.length === 0">
                                    <div class="flex flex-col items-center justify-center py-16 text-center">
                                        ...
                                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-loose max-w-[12rem]">No birthdays or anniversaries noted for <span class="text-slate-900 font-black" x-text="selectedDate + ' ' + monthName"></span></p>
                                    </div>
                                </template>
                                    ...
                                    <div class="p-6 rounded-3xl bg-white shadow-sm border border-slate-100 flex items-start gap-5 transform transition-all hover:scale-[1.02] hover:shadow-md group">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center gap-2 mb-2">
                                                <div class="h-1 w-1 rounded-full" :class="event.type === 'anniversary' ? 'bg-pink-500' : 'bg-slate-200'"></div>
                                                <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest" x-text="event.type === 'anniversary' ? 'Anniversary' : 'Personal Milestone'"></p>
                                            </div>
                                            <template x-if="event.phone">
                                                <a :href="`https://wa.me/91${event.phone.replace(/\D/g, '')}?text=Happy ${event.type === 'anniversary' ? 'Anniversary' : 'Birthday'}, ${event.name}! 🎉`" target="_blank" class="text-[10px] font-black bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366] hover:text-white px-3 py-1.5 rounded-lg inline-flex items-center gap-1.5 transition-colors border border-[#25D366]/20">
