            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    syncPolicyDetails() {
                        ...
                        <div class="relative min-h-[42px] mt-1">
                            ...
                            <div x-show="!(availablePolicies && availablePolicies.length > 0) || manualInput || policyNumberInput === 'manual'">
                                <x-text-input id="policy_number_manual" name="policy_number_manual" type="text" 
                                       class="block w-full" x-model="policyNumberInput" 
