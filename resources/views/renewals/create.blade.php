            ...
            <div class="premium-card">
                ...
                <form action="{{ route('renewals.store') }}" method="POST" class="space-y-8" x-data="{ 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="relative">
                            <x-form-input label="Policy Number" name="policy_number" required x-model="policyNumberInput" list="policy_list_data" autocomplete="one-time-code" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <p class="text-[9px] font-bold text-emerald-600 dark:text-emerald-500 mt-1 uppercase tracking-widest">Affects only this entry (Overrides Master Default).</p>
                            </div>
