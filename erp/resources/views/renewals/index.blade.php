        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-10 px-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('renewals.create') }}" class="inline-flex items-center gap-2 bg-emerald-600 text-white px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-200 dark:shadow-none hover:bg-emerald-500 transition-all">
                                        ...
                                        <div class="flex items-center justify-end gap-3 text-xs font-black uppercase tracking-widest">
                                            ...
                                            @if($renewal->client && $renewal->client->phone)
                                                ...
                                                <button @click="$dispatch('open-messaging-modal', { 
                                                    title: 'Send Policy Renewal', 
                                                    message: @js($waMessage), 
                                                    phone: '{{ $waPhone }}', 
                                                    name: '{{ addslashes($renewal->client->name ?? '') }}' 
                                                })" 
