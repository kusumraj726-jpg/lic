    ...
    <nav class="sidebar-nav">
        ...
        @if($actualUser && $actualUser->role === 'superadmin')
            <div class="mt-6 pt-6 border-t border-gray-100/50 space-y-1">
                ...
                <a href="{{ route('superadmin.system-updates') }}"
                    class="nav-item {{ request()->routeIs('superadmin.system-updates') ? 'active' : '' }} bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 font-bold border border-emerald-500/20 hover:bg-emerald-500/20 shadow-sm transition-all mt-1">
                    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-emerald-600 dark:text-emerald-400">
