                                    ...
                                    <td class="px-8 py-6 text-right">
                                        <div class="flex items-center justify-end gap-3 text-xs font-black uppercase tracking-widest">
                                            ...
                                            @if($claim->client && $claim->client->phone)
                                                ...
                                                @endphp
                                                <a href="{{ $waUrl }}" target="_blank" class="p-2 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 hover:text-emerald-600 dark:hover:text-emerald-400 rounded-xl transition-all" title="Send via WhatsApp">
