                                    ...
                                    <td class="px-8 py-6 text-right">
                                        <div class="flex items-center justify-end gap-3 text-xs font-black uppercase tracking-widest">
                                            ...
                                            @if($claim->client && $claim->client->phone)
                                                ...
                                                @endphp
                                                <a href="{{ $waUrl }}" target="_blank" class="text-emerald-600 dark:text-emerald-400 hover:text-emerald-900 dark:hover:text-emerald-300 flex items-center gap-1.5 transition-all hover:scale-110">
